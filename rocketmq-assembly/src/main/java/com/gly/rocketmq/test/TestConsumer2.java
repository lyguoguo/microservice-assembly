...
@Slf4j
@Configuration
public class TestConsumer2 extends ConsumerConfigure implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public ConsumeConcurrentlyStatus dealBody(List<MessageExt> msgs) {
        ...
        log.info("【我是二号TAG】Message Consumer: Handle New Message: messageId: " + message.getMsgId() + ",topic: " +
