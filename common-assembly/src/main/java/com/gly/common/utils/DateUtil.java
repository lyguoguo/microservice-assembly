...
public class DateUtil {
    ...
    public static ArrayList<String> listDays(String smallDate, String bigDate) throws ParseException {
        ...
        for (int i = 0; i <= days; i++) {
            resultDays.add(DateUtil.date2Str(DateUtils.addDays(DateUtil.parseDate(smallDate, "yyyy-MM-dd"), i), "yyyy-MM-dd"));
        }
        return resultDays;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(!"2016-11-01".equals(getTodayDate("09:37")));
        System.out.println(getTodayDate("09:37"));
    }

    /** 
    * @Title: parseStringToDate 
    * @Description: (这里用一句话描述这个方法的作用) 
    * @param @param mobileTime
    * @param @return    设定文件 
    * @return Date    返回类型 
    * @throws 
    */
    public static Date parseStringToDate(String mobileTime) { //mobileTime 页面传过来的时间戳
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
     ...
     * 2017-6-27 14:21:55
     */
    public static Date crtRandomTime(Calendar c1, Calendar c2) {
        long date = c1.getTimeInMillis() + (long) (Math.random() * (c2.getTimeInMillis() - c1.getTimeInMillis()));
     ...
     * @param
     * @param time  如：16:30
     *       当前时间点超过16:30，该时间点为当天时间
     * @return
     */
    public static String getTodayDate(String time) {
        Calendar cal = Calendar.getInstance();
        Date date = new Date();
